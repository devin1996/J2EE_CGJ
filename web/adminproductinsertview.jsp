	...
	<section class="bg0 p-t-104 p-b-116">
		<div class="container">
            ...
            <tr>
                ...
                <th style="padding: 20px;">Name Of the Product</th>               
            ...
            <td style="padding: 10px;"><%=rs.getString("price")%></td>
            <td style="padding: 10px;"><%=rs.getString("details")%></td>
            <td style="padding: 10px;"><%=rs.getString("image")%></td>
            </tr>
            <% }
                   %>
